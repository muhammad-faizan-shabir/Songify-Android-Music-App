...
class MainActivity : AppCompatActivity() {
    ...
    //For requesting permission to access audio file in phone's storage
    ...
    // logic to extract all audio data from phone's storage
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                ...
                if(newText != null){
                    ...
                    for (song in MusicListMA)
                        if(song.title.lowercase().contains(userInput) || song.album.lowercase().contains(userInput) || song.artist.lowercase().contains(userInput))
